...
| Variable Name           | Type      | Description                                                                                                                                                                                                                                                   | Example   |
| ----------------------- | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------- |
| `ENABLE_MARKETING_DEDUP` | boolean   | Whether to enable marketing email deduplication across mailboxes; identical promotional emails are stored and forwarded only on first receipt, subsequent duplicates are skipped                                                                              | `true`    |
| `MARKETING_DEDUP_TTL`   | number    | Marketing email fingerprint cache TTL in seconds, defaults to 7 days (`604800`)                                                                                                                                                                              | `604800`  |
